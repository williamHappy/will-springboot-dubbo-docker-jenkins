package com.springic.entity.user;
...
public class UserEntity implements Serializable {
    ...
    /** 用户类型 {@link com.springic.enumeration.user.UserTypeEnum} */
    private UserTypeEnum userTypeEnum;

    /** 账号状态 {@link com.springic.enumeration.user.UserStateEnum } */
