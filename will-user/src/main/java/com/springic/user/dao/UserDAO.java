package com.springic.user.dao;

import com.springic.entity.user.*;
import com.springic.req.user.LocationUpdateReq;
import com.springic.req.user.RoleMenuReq;
import com.springic.req.user.RolePermissionReq;
import com.springic.req.user.UserQueryReq;
